...
model Prop43ValveTestSimpleDeadZone_PID
...
equation
  ...
  connect(throttleValve.control, PID.y)
    annotation (Line(points={{41.0024,0},{79,0}}, color={0,0,127}));
  connect(sine1.y, PID.u_s)
    annotation (Line(points={{123,0},{102,0}}, color={0,0,127}));
...
end Prop43ValveTestSimpleDeadZone_PID;
